...
class UnbindCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'amqp:unbind
     ...
     * @var string
     */
    protected $description = 'Unbind queue to exchange';
    ...
    public function handle(ConnectionFactory $factory)
    {
        ...
        try {
            $connection->unbind(new AmqpBind(
        ...
        $this->info('Unbind queue to exchange successfully.');
    }
}
